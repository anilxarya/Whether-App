        ...
        <div className='flex flex-wrap justify-between gap-5 w-full my-5 h-auto'>
            {whetherData && ( 
                ...
                <div className={cardStyle}>
                    <img className='w-12 h-12 ' src="/water.png" alt="humidity-image" />
                    <span className='font-medium'>Humidity</span>
                    <span className='font-medium text-[18px]'>{whetherData?.current?.humidity}%</span>
                </div>
               
                <div className={cardStyle}>
                    <img className='w-12 h-12 ' src="/wind.png" alt="windspeed-image" />
                    <span className='font-medium'>Wind Speed</span>
                    <span className='font-medium text-[18px]'>{whetherData?.current?.wind_kph} km/h</span>
                </div>
                  
                 <div className={cardStyle}>
                    <div className='flex items-center justify-center bg-pink-400 rounded-full w-12 h-12'><img className='w-8 h-8 rouded-full' src="/vision.png" alt="vis-image" /></div>
                    <span className='font-medium'>Visibility</span>
                    <span className='font-medium text-[18px]'>{whetherData?.current?.vis_km} km</span>
                </div>

                <div className={cardStyle}>
                    <img className='w-12 h-12 ' src="/cloud.png" alt="vis-image" />
                    <span className='font-medium'>Clouds Cover</span>
                    <span className='font-medium text-[18px]'>{whetherData?.current?.cloud} %</span>
                </div>

                <div className={cardStyle}>
                    <img className='w-12 h-12 ' src="/sun.png" alt="vis-image" />
                 ...
                 <div className={cardStyle}>
                    <img className='w-12 h-12 ' src="/thermometer.png" alt="vis-image" />
                    <span className='font-medium'>Feels Like</span>
                    <span className='font-medium text-[18px]'>{whetherData?.current?.feelslike_c}&deg; C</span>
                </div>

                 <div className={cardStyle}>
                    <img className='w-12 h-12 ' src="/pressure-gauge.png" alt="vis-image" />
                    <span className='font-medium'>Pressure</span>
                    <span className='font-medium text-[18px]'>{whetherData?.current?.pressure_mb} mb</span>
                </div>

                  <div  className={cardStyle}>
                    <div className='flex items-center justify-center bg-gray-700 rounded-full w-12 h-12'><img className='w-8 h-8 rouded-full' src="/wind-socket.png" alt="vis-image" /></div>
